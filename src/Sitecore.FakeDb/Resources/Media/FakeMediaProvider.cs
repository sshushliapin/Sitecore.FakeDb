namespace Sitecore.FakeDb.Resources.Media
{
    ...
    public class FakeMediaProvider : MediaProvider, IThreadLocalProvider<MediaProvider>
    {
        ...
        {
            get { return this.IsLocalProviderSet() ? this.localProvider.Value.Cache : this.mediaCache; }
        ...
        {
            get { return this.IsLocalProviderSet() ? this.localProvider.Value.Config : this.mediaConfig; }
        ...
        {
            get { return this.IsLocalProviderSet() ? this.localProvider.Value.Creator : this.mediaCreator; }
        ...
        {
            get { return this.IsLocalProviderSet() ? this.localProvider.Value.Effects : this.imageEffects; }
        ...
        {
            get { return this.IsLocalProviderSet() ? this.localProvider.Value.MimeResolver : this.mimeResolver; }
